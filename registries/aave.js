...
const aaveV2Configs = {
  ...
  'unleash': {
    methodology,
    sty: { registry: '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', isAaveV3Fork: true, isInsolvent: true },
  },
  'lendle': {
    mantle: {
      registry: '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1',
  ...
  'bonzo': {
    timetravel: false,
    methodology,
    hedera: '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE',
  },
  'takoTako': {
    methodology,
    taiko: {
...
const aaveConfigs = {
  ...
  'luckypeaches': {
    ...
    hyperliquid: { dataHelpers: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'] },
  },
  'seamless': {
    methodology,
    base: {
  ...
  'sculptor-finance': {
    ...
    bsc: {
      addressesProviderRegistry: '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1',
      staking: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'],
      pool2: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'],
    },
  },
  'valas': {
    methodology,
  ...
  'zerolend': {
    ...
    era: { dataHelpers: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'], isInsolvent: true },
    manta: { dataHelpers: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'], isInsolvent: true },
    blast: { dataHelpers: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'], isInsolvent: true },
    hemi: { dataHelpers: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'], isInsolvent: true },
    base: { dataHelpers: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'], isInsolvent: true },
    linea: {
      dataHelpers: [
        '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', // main linea market
        '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', // croak linea market
        '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', // foxy linea market
      ],
      isInsolvent: true,
      staking: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'], // zeroLocker, zero
      pool2: [['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'], ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1']], // zlpLocker, zeroEthNileLP
    },
    xlayer: { dataHelpers: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'], isInsolvent: true },
    zircuit: { dataHelpers: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'], isInsolvent: true },
    ethereum: {
      dataHelpers: [
        '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', // ethereum lrt market
        '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', // bitcoin lrt market
        '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', // stablecoin rwa market
      ],
      isInsolvent: true,
    },
    corn: { dataHelpers: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'], isInsolvent: true },
    abstract: { dataHelpers: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'], isInsolvent: true },
  },
  ...
  'dtrinity-dlend': {
    ...
    ethereum: {
      dataHelpers: ['0x3211d27a1A1B8E40C7974F6951935303e6e56DBE'],
      v3: true,
      blacklistedTokens: ['0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1'],  // exclude dETH & dUSD
    },
  },
  'apebank': {
  ...
  'hadouken-fi-lending': {
    godwoken_v1: '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE',
  },
  'glyph-fi': {
